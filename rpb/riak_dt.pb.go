...
func (x MapField_MapFieldType) MarshalJSON() ([]byte, error) {
...
func (x DtFetchResp_DataType) MarshalJSON() ([]byte, error) {
	return json.Marshal(x.String())
}
...
func (x MapUpdate_FlagOp) MarshalJSON() ([]byte, error) {
	return json.Marshal(x.String())
}
...
type MapField struct {
	...
	Type             *MapField_MapFieldType `protobuf:"varint,2,req,name=type,enum=rpb.MapField_MapFieldType" json:"type,omitempty"`
...
type DtFetchResp struct {
	...
	Type             *DtFetchResp_DataType `protobuf:"varint,2,req,name=type,enum=rpb.DtFetchResp_DataType" json:"type,omitempty"`
...
type MapUpdate struct {
	...
	FlagOp           *MapUpdate_FlagOp `protobuf:"varint,5,opt,name=flag_op,enum=rpb.MapUpdate_FlagOp" json:"flag_op,omitempty"`
...
func init() {
	proto.RegisterEnum("rpb.MapField_MapFieldType", MapField_MapFieldType_name, MapField_MapFieldType_value)
	proto.RegisterEnum("rpb.DtFetchResp_DataType", DtFetchResp_DataType_name, DtFetchResp_DataType_value)
	proto.RegisterEnum("rpb.MapUpdate_FlagOp", MapUpdate_FlagOp_name, MapUpdate_FlagOp_value)
}
